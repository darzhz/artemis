  ...
  return (
    <div className="container mx-auto mt-8">
      ...
      <div className="DateBox">
        {subjectsData.map((subject, index) => (
          ...
          >
            ...
            <p className="text-sm text-gray-600 hover:text-white">{subject.subinfo[0].module}</p>
          </div>
        ))}
      </div>
      {selectedSubjectIndex !== null && (
          ...
          <button className="button" onClick={()=>window.location.href = '/subjects/generate'}>Download Lesson Plan</button>
        </div>
      )}
