...
router.get('/generateLesson/:sub_code',async (req,res)=> {
    // const data = {
    //     "sub_code": "IT456",
    ...
    //     ]
    //   }
    const data = await model.getSubjectsBySubCode(req.params.sub_code);
    console.log(data);
      
    util.generateExcel(data.subjects,req,res);
})
